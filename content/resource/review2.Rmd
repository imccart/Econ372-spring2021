...
2. To find the optimal $Q$, we need to differentiate, set equal to 0, then solve for $Q$. In this case, $\pi'(Q) = 80 - 2Q - 10$, which equals 0 for $Q=35$. Price at this quantity is $P=80-Q=5$.
